...
public class FindTheLongestSubstringFromAGivenStringWhichDoesntContainAnyDuplicateCharacters {
	...
	public static void main(String a[]) {
		...
		FindTheLongestSubstringFromAGivenStringWhichDoesntContainAnyDuplicateCharacters substr = new FindTheLongestSubstringFromAGivenStringWhichDoesntContainAnyDuplicateCharacters();
